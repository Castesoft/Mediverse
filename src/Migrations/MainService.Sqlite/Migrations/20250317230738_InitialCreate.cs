        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirth = table.Column<DateOnly>(type: "TEXT", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ...
                    RequireAnticipatedCardPayments = table.Column<bool>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsesGlassesOrHearingAid = table.Column<bool>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    HasClinicalHistoryAccess = table.Column<bool>(type: "INTEGER", nullable: false),
                    ConsentGrantedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventMedicalInsuranceCompany_MedicalInsuranceCompanies_MedicalInsuranceCompanyId",
                        column: x => x.MedicalInsuranceCompanyId,
                        principalTable: "MedicalInsuranceCompanies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalRecordColorBlindnesses_ColorBlindnesses_ColorBlindnessId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalRecordEducationLevels_EducationLevels_EducationLevelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventPaymentMethodType_PaymentMethodTypes_PaymentMethodTypeId",
                        column: x => x.PaymentMethodTypeId,
                        principalTable: "PaymentMethodTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalRecordFamilyMemberRelativeTypes_FamilyMembers_FamilyMemberId",
                        column: x => x.FamilyMemberId,
                        principalTable: "FamilyMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalRecordFamilyMemberRelativeTypes_RelativeTypes_RelativeTypeId",
                        column: x => x.RelativeTypeId,
                        principalTable: "RelativeTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TooExpensive = table.Column<bool>(type: "INTEGER", nullable: false),
                    NotEnoughUse = table.Column<bool>(type: "INTEGER", nullable: false),
                    FoundAlternative = table.Column<bool>(type: "INTEGER", nullable: false),
                    MissingFeatures = table.Column<bool>(type: "INTEGER", nullable: false),
                    TechnicalProblems = table.Column<bool>(type: "INTEGER", nullable: false),
                    PoorSupport = table.Column<bool>(type: "INTEGER", nullable: false),
                    OtherReason = table.Column<bool>(type: "INTEGER", nullable: false),
                    Feedback = table.Column<string>(type: "TEXT", maxLength: 1500, nullable: true),
