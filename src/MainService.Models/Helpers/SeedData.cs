...
namespace MainService.Models.Helpers
{
    ...
    public static partial class SeedData
    {
        ...
        public static readonly List<Substance> Substances = [
            ...
            new("marijuana", "Marihuana", "Droga recreativa que afecta la percepción y la coordinación, legal en algunos países o estados."),
            new("cocaine", "Cocaína", "Droga ilegal que estimula el sistema nervioso central, creando dependencia y afectando la salud cardiovascular."),
            new("inhalants", "Inhalantes", "Sustancias químicas inhaladas que alteran el estado mental y pueden causar daño a los órganos internos."),
            new("caffeine", "Cafeína", "Sustancia estimulante que se encuentra en bebidas como café y refrescos, puede causar dependencia leve."),
            new("other", "Otros (anfetaminas, metanfetaminas, heroína, cristal)", "Sustancias ilegales y altamente adictivas que afectan el sistema nervioso central y la salud en general.")
        ];
        ...
        public static readonly List<ConsumptionLevel> ConsumptionLevels = [
            ...
            new("mild", "Leve", "El paciente consume la sustancia ocasionalmente, sin impacto significativo en la salud."),
            new("moderate", "Moderado", "El paciente consume la sustancia de forma regular, con algún impacto en la salud o comportamiento."),
            new("severe", "Severo", "El paciente consume la sustancia con frecuencia, afectando gravemente su salud o vida cotidiana."),
            new("dependent", "Dependencia", "El paciente es dependiente de la sustancia y tiene dificultad para controlar su uso.")
        ];

        public static readonly List<Disease> Diseases = [
            new("cancer", "Cáncer", "Enfermedad que implica el crecimiento incontrolado de células anormales en el cuerpo."),
            new("diabetes", "Diabetes", "Enfermedad que afecta la forma en que el cuerpo usa el azúcar en la sangre."),
            new("hypertension", "Hipertensión", "Presión arterial elevada, una afección común que puede aumentar el riesgo de problemas cardiacos."),
            new("cholesterol", "Colesterol", "Altos niveles de colesterol en la sangre, lo que puede llevar a problemas de salud, como enfermedades cardíacas."),
            new("heart_issues", "Problemas cardiacos (infartos)", "Condiciones que afectan al corazón, como ataques cardíacos."),
            new("major_surgeries", "Intervenciones quirúrgicas mayores", "Cirugías que involucran grandes procedimientos médicos."),
            new("allergies_asthma", "Alergias o asma", "Reacciones exageradas del sistema inmune a ciertos alérgenos o enfermedades respiratorias como el asma."),
            new("tremor", "Temblor", "Movimientos involuntarios, comúnmente en las manos u otras partes del cuerpo."),
            new("miscarriages", "Abortos (solo para mujeres)", "Pérdida del embarazo, puede ser espontánea o inducida."),
            new("eating_disorders", "Trastornos alimenticios", "Condiciones relacionadas con comportamientos alimenticios anormales, como anorexia o bulimia."),
            new("weight_issues", "Sobrepeso o desnutrición", "Condiciones donde el peso corporal está fuera de los rangos saludables, ya sea por exceso o por falta de nutrientes."),
            new("psychiatric_disorders", "Psiquiátricos (depresión, ansiedad, bipolar, etc.)", "Trastornos mentales que afectan el estado de ánimo, el comportamiento y el pensamiento."),
            new("dementias", "Demencias (Parkinson, Alzheimer)", "Enfermedades que implican la pérdida progresiva de la memoria y otras funciones cognitivas."),
            new("memory_issues", "Problemas de memoria", "Dificultades para recordar información y eventos."),
            new("attention_issues", "Problemas de atención", "Dificultad para concentrarse o mantener la atención en actividades."),
            new("intellectual_disabilities", "Retraso mental, Síndrome de Down", "Condiciones que causan discapacidades intelectuales y de desarrollo."),
            new("other", "Otros (tiroides, gastrointestinales, ginecológicas, hepáticas, respiratorias, renales, etc.)", "Otras enfermedades que incluyen el sistema endocrino, digestivo, reproductivo, hepático, respiratorio o renal.")
        ];

        public static readonly List<MaritalStatus> MaritalStatuses = [
            new("single", "Soltero", "El paciente no ha contraído matrimonio y no está en una relación de pareja formal."),
            ...
            new("remarried", "Segundas nupcias", "El paciente está casado nuevamente después de un matrimonio anterior."),
        ...
        public static readonly List<RelativeType> RelativeTypes = [
            ...
            new("other", "Otro (especificar)", "La persona tiene una relación distinta con el paciente, y se puede especificar.")
        ];
        ...
        public static readonly List<Occupation> Occupations = [
            ...
            new("other", "Otra (especificar)", "El paciente tiene una ocupación distinta a las listadas, y puede especificarla.")
        ];
        ...
        public static readonly List<EducationLevel> EducationLevels = [
            ...
            new("secondary_incomplete", "Secundaria incompleta", "El paciente no ha terminado la educación secundaria."),
            new("secondary_complete", "Secundaria completa", "El paciente ha completado la educación secundaria."),
            new("highschool_incomplete", "Preparatoria incompleta", "El paciente no ha terminado la educación preparatoria o equivalente."),
            new("highschool_complete", "Preparatoria completa", "El paciente ha completado la educación preparatoria o equivalente."),
            new("technical_degree", "Técnico superior", "El paciente ha completado un nivel técnico superior, como una carrera técnica."),
            new("bachelor_incomplete", "Licenciatura incompleta", "El paciente no ha terminado la educación universitaria de nivel licenciatura."),
            new("bachelor_complete", "Licenciatura completa", "El paciente ha completado una licenciatura universitaria."),
            new("masters_incomplete", "Maestría incompleta", "El paciente no ha terminado estudios de posgrado a nivel de maestría."),
            new("masters_complete", "Maestría completa", "El paciente ha completado estudios de posgrado a nivel de maestría."),
