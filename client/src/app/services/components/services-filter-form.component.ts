...
import { FilterForm, ServiceParams } from 'src/app/_models/service';
...
import { ServicesFilterModalComponent } from 'src/app/services/modals';
import { ServicesService } from 'src/app/_services/services.service';

@Component({
  selector: 'div[servicesFilterForm]',
  template: `
  <form
...
export class ServicesFilterFormComponent implements OnInit {
  ...
  modalRef: BsModalRef<ServicesFilterModalComponent> = new BsModalRef<ServicesFilterModalComponent>();
