...
import { EducationLevel, EducationLevelParams, EducationLevelsService, sortOptions } from "src/app/educationLevels/educationLevels.config";
...
<form [id]="form.id" (ngSubmit)="onSubmit()">
  <mat-accordion class="example-headers-align" [displayMode]="'flat'">
    <mat-expansion-panel hideToggle class="border" [(expanded)]="toggle">
      ...
      <button type="button" color="secondary" mat-stroked-button (click)="service.downloadXLSX$(key(), 'EducationLevels')">Descargar</button>
    </mat-expansion-panel>
  </mat-accordion>
</form>
}
