...
import { Occupation, OccupationParams, OccupationsService, sortOptions } from "src/app/occupations/occupations.config";
...
<form [id]="form.id" (ngSubmit)="onSubmit()">
  <mat-accordion class="example-headers-align" [displayMode]="'flat'">
    <mat-expansion-panel hideToggle class="border" [(expanded)]="toggle">
      ...
      <button type="button" color="secondary" mat-stroked-button (click)="service.downloadXLSX$(key(), 'Occupations')">Descargar</button>
    </mat-expansion-panel>
  </mat-accordion>
</form>
}
