...
import { OccupationsFilterFormComponent } from "./occupations-filter-form.component";
import { FontAwesomeModule } from "@fortawesome/angular-fontawesome";
import { CommonModule } from "@angular/common";
import { OccupationsTableComponent } from "./occupations-table.component";
...
import { Occupation, OccupationParams, OccupationsService } from "src/app/occupations/occupations.config";
...
@Component({
  ...
  template: `
  <div class="pb-2">
  <h1 class="mb-4">{{ service.dictionary.Occupations.title}}</h1>
  <div>
    <div class="row align-items-center justify-content-between g-3 mb-2">
      <div class="col-12 col-md-auto">
        <a type="button" class="btn btn-primary me-4" (click)="service.clickLink(undefined, key(), 'create', 'page')">
          ...
          Crear {{ service.dictionary.Occupations.singular }}
        </a>
        ...
        <button mat-raised-button [matBadge]="count" matBadgePosition="after" (click)="service.deleteRange$(key())">
          Eliminar {{ count > 1 ? service.dictionary.Occupations.plural : service.dictionary.Occupations.singular }}
        </button>
        }
        }
      </div>
