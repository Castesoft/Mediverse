...
export const medicalLicenseFormInfo: FormInfo<MedicalLicense> = {
  ...
  licenseNumber: { label: 'Número de licencia', type: 'text', validators: [Validators.required, Validators.minLength(7), Validators.maxLength(7), ] },
  specialtyLicense: { label: 'Especialidad de licencia', type: 'text', validators: [Validators.required, Validators.minLength(7), Validators.maxLength(7), ], },
