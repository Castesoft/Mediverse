          ...
          <div class="w-lg-550px p-10 p-lg-15 mx-auto">
            ...
            >
              <div class="text-center mb-10">
                <h1 class="text-dark mb-3">Establecer nueva contraseña</h1>

                <div class="text-gray-400 fw-semibold fs-4">
                  ¿Ya habías restablecido tu contraseña?

                  <a
                    routerLink="/auth/sign-in/basic"
              ...
              >
                ...
                <div class="text-muted">
                  Usa 8 o más caracteres con una combinación de letras, números
                  y símbolos.
                </div>
                <div
              ...
              <div class="fv-row mb-10 fv-plugins-icon-container">
                ...
                >
                  ...
                  <span class="form-check-label fw-semibold text-gray-700 fs-6">
                    ...
                    <a [routerLink]="[]" class="ms-1 link-primary"
...
@NgModule({
  imports: [RouterModule.forChild([
    { path: 'basic', component: SignUpBasicComponent },
