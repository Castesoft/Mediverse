...
@Component({
  selector: '[maritalStatusesFilterForm]',
  template: `
  @if(role() === 'compact') {
...
export class MaritalStatusesFilterFormComponent extends FormComponent<MaritalStatusesService> implements OnInit, FilterFormGroupActions<MaritalStatus, MaritalStatusParams, FormGroup2<MaritalStatusParams>> {
  ...
  private ngUnsubscribe = new Subject<void>();
  params!: MaritalStatusParams;
  info: FormInfo<MaritalStatusParams> = {
  ...
  form: FormGroup2<MaritalStatusParams> = new FormGroup2<MaritalStatusParams>(MaritalStatusParams as any, new MaritalStatusParams(createId()), this.info, { orientation: 'inline', use: 'filter' });
  ...
  onSubmit() {
    ...
    // this.service.submitForm(this.key(), result as MaritalStatusParams);
  }
}
...
@Component({
  selector: "div[maritalStatusForm]",
  template: `
  <form [id]="form.id" (ngSubmit)="onSubmit()">
...
export class MaritalStatusesService extends ServiceHelper<MaritalStatus, MaritalStatusParams, FormGroup2<MaritalStatusParams>> {
  constructor() {
    super(MaritalStatusParams, 'maritalStatuses', new NamingSubject(
      'feminine',
      'especialidad',
      'especialidades',
      'Especialidades',
  ...
  clickLink = (item: MaritalStatus | undefined = undefined, key: string | undefined = undefined,
