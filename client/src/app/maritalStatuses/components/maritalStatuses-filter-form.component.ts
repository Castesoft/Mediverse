...
import { MaritalStatus, MaritalStatusParams, MaritalStatusesService, sortOptions } from "src/app/maritalStatuses/maritalStatuses.config";
...
<form [id]="form.id" (ngSubmit)="onSubmit()">
  <mat-accordion class="example-headers-align" [displayMode]="'flat'">
    <mat-expansion-panel hideToggle class="border" [(expanded)]="toggle">
      ...
      <button type="button" color="secondary" mat-stroked-button (click)="service.downloadXLSX$(key(), 'MaritalStatuses')">Descargar</button>
    </mat-expansion-panel>
  </mat-accordion>
</form>
}
