...
export class DiseasesService extends ServiceHelper<Disease, DiseaseParams, FormGroup2<DiseaseParams>> {
  constructor() {
    super(DiseaseParams, 'diseases', new NamingSubject(
      'feminine',
      'especialidad',
      'especialidades',
      'Especialidades',
  ...
  clickLink = (item: Disease | undefined = undefined, key: string | undefined = undefined,
