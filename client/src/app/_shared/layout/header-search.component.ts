...
@Component({
  ...
  template: `
    <div id="kt_header_search" class="header-search d-flex align-items-center w-100 w-lg-300px"
         dropdown #dropdown="bs-dropdown" [triggers]="'focus'"
         [insideClick]="true">
      <div class="dropdown-toggle search-toggle-mobile d-flex d-lg-none align-items-center" dropdownToggle>
        <div class="d-flex">
      ...
      <form [formGroup]="searchForm"
        ...
        <input #searchInput formControlName="searchTerm" type="text"
               class="search-input form-control form-control-solid ps-13" placeholder="Search...">

        @if (state === 'loading') {
          <span class="search-spinner position-absolute top-50 end-0 translate-middle-y lh-0 me-5"
          >
        ...
        @if (state === 'filled') {
          <span (click)="
            ...
            mode = 'recent';
          "
                class="search-reset btn btn-flush btn-active-color-primary position-absolute top-50 end-0 translate-middle-y lh-0 me-4"
          >
      ...
      <div
        class="menu menu-sub menu-sub-dropdown py-7 px-7 overflow-hidden w-300px w-md-350px dropdown-menu"
        *dropdownMenu>
        <div>
          @switch (mode) {
            @case ('recent') {
                ...
                <div class="d-flex flex-stack fw-semibold mb-4">
                  ...
                  <div class="d-flex">
                    <div
                      ...
                      title="Show search preferences" (click)="mode = 'preferences'">
            ...
            @case ('results') {
              <div>
                <div class="scroll-y mh-200px mh-lg-350px">
                  ...
                  <h3 class="fs-5 text-muted m-0 pt-5 pb-5">Customers
                  </h3>
                  <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                    <div class="symbol symbol-40px me-4">
              <span class="symbol-label bg-light">
              ...
              <form class="pt-1">
                ...
                <div class="mb-5">
                  <select name="timezone" aria-label="Select a Timezone" data-control="select2"
                          ...
                          data-select2-id="select2-data-1-wfch" tabindex="-1" aria-hidden="true">
                    <option value="next" data-select2-id="select2-data-3-bjv6">Within the next</option>
                    <option value="last">Within the last</option>
                    <option value="between">Between</option>
                    <option value="on">On</option>
                  </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr"
                                 data-select2-id="select2-data-2-tctv" style="width: 100%;"><span
                  ...
                  aria-labelledby="select2-timezone-v2-container" aria-controls="select2-timezone-v2-container"><span
                  class="select2-selection__rendered" id="select2-timezone-v2-container" role="textbox"
                ...
                <div class="row mb-8">
                  ...
                  <div class="col-6">
                    <select name="date_typer" aria-label="Select a Timezone" data-control="select2"
                            ...
                            class="form-select form-select-sm form-select-solid select2-hidden-accessible"
                            data-select2-id="select2-data-4-wymr" tabindex="-1" aria-hidden="true">
                      <option value="days" data-select2-id="select2-data-6-osub">Days</option>
                      <option value="weeks">Weeks</option>
                      <option value="months">Months</option>
                      <option value="years">Years</option>
                    </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr"
                                   data-select2-id="select2-data-5-46nm" style="width: 100%;"><span
                    class="selection"><span
                    class="select2-selection select2-selection--single form-select form-select-sm form-select-solid"
                    role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false"
                    aria-labelledby="select2-date_typer-o0-container"
                    aria-controls="select2-date_typer-o0-container"><span class="select2-selection__rendered"
                                                                          id="select2-date_typer-o0-container"
