...
@Component({
  selector: 'div[adminProductsCatalogRoute]',
  template: `
    <div breadcrumbs></div>
    <div post>
...
export class AdminProductsCatalogRouteComponent extends BaseRouteCatalog<Product, ProductParams, ProductFiltersForm, ProductsService> {
  constructor() {
