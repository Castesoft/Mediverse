...
@Component({
  selector: '[relativeTypesFilterForm]',
  template: `
  @if(role() === 'compact') {
...
export class RelativeTypesFilterFormComponent extends FormComponent<RelativeTypesService> implements OnInit, FilterFormGroupActions<RelativeType, RelativeTypeParams, FormGroup2<RelativeTypeParams>> {
  ...
  private ngUnsubscribe = new Subject<void>();
  params!: RelativeTypeParams;
  info: FormInfo<RelativeTypeParams> = {
  ...
  form: FormGroup2<RelativeTypeParams> = new FormGroup2<RelativeTypeParams>(RelativeTypeParams as any, new RelativeTypeParams(createId()), this.info, { orientation: 'inline', use: 'filter' });
  ...
  onSubmit() {
    ...
    // this.service.submitForm(this.key(), result as RelativeTypeParams);
  }
}
...
export class RelativeTypesService extends ServiceHelper<RelativeType, RelativeTypeParams, FormGroup2<RelativeTypeParams>> {
  constructor() {
    super(RelativeTypeParams, 'relativeTypes', new NamingSubject(
      'feminine',
      'especialidad',
      'especialidades',
      'Especialidades',
  ...
  clickLink = (item: RelativeType | undefined = undefined, key: string | undefined = undefined,
