...
import { RelativeType, RelativeTypeParams, RelativeTypesService, sortOptions } from "src/app/relativeTypes/relativeTypes.config";
...
<form [id]="form.id" (ngSubmit)="onSubmit()">
  <mat-accordion class="example-headers-align" [displayMode]="'flat'">
    <mat-expansion-panel hideToggle class="border" [(expanded)]="toggle">
      ...
      <button type="button" color="secondary" mat-stroked-button (click)="service.downloadXLSX$(key(), 'RelativeTypes')">Descargar</button>
    </mat-expansion-panel>
  </mat-accordion>
</form>
}
