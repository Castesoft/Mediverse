...
@Component({
  selector: "div[controlButtonToggleMultiple3]",
  templateUrl: "./control-button-toggle-multiple-3.component.html",
  standalone: true,
  styles: `
...
export class ControlButtonToggleMultiple3Component {
