...
export const stateOptions: SelectOption[] = [
  new SelectOption({ name: "Aguascalientes"}),
  new SelectOption({ name: "Baja California"}),
  new SelectOption({ name: "Baja California Sur"}),
  new SelectOption({ name: "Campeche"}),
  new SelectOption({ name: "Chiapas"}),
  new SelectOption({ name: "Chihuahua"}),
  new SelectOption({ name: "Ciudad de México"}),
  new SelectOption({ name: "Coahuila"}),
  new SelectOption({ name: "Colima"}),
  new SelectOption({ name: "Durango"}),
  new SelectOption({ name: "Estado de México"}),
  new SelectOption({ name: "Guanajuato"}),
  new SelectOption({ name: "Guerrero"}),
  new SelectOption({ name: "Hidalgo"}),
  new SelectOption({ name: "Jalisco"}),
  new SelectOption({ name: "Michoacán"}),
  new SelectOption({ name: "Morelos"}),
  new SelectOption({ name: "Nayarit"}),
  new SelectOption({ name: "Nuevo León"}),
  new SelectOption({ name: "Oaxaca"}),
  new SelectOption({ name: "Puebla"}),
  new SelectOption({ name: "Querétaro"}),
  new SelectOption({ name: "Quintana Roo"}),
  new SelectOption({ name: "San Luis Potosí"}),
  new SelectOption({ name: "Sinaloa"}),
  new SelectOption({ name: "Sonora"}),
  new SelectOption({ name: "Tabasco"}),
  new SelectOption({ name: "Tamaulipas"}),
  new SelectOption({ name: "Tlaxcala"}),
  new SelectOption({ name: "Veracruz"}),
