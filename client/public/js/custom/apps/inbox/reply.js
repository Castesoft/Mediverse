...
var KTAppInboxReply = function () {
    ...
    const initTagify = (el) => {
        ...
        const usersList = [
            { value: 1, name: 'Emma Smith', avatar: 'avatars/300-6.jpg', email: 'redacted+006@example.invalid' },
            { value: 2, name: 'Max Smith', avatar: 'avatars/300-1.jpg', email: 'redacted+013@example.invalid' },
            { value: 3, name: 'Sean Bean', avatar: 'avatars/300-5.jpg', email: 'redacted+024@example.invalid' },
            { value: 4, name: 'Brian Cox', avatar: 'avatars/300-25.jpg', email: 'redacted+003@example.invalid' },
            { value: 5, name: 'Francis Mitcham', avatar: 'avatars/300-9.jpg', email: 'redacted+009@example.invalid' },
            { value: 6, name: 'Dan Wilson', avatar: 'avatars/300-23.jpg', email: 'redacted+004@example.invalid' },
            { value: 7, name: 'Ana Crown', avatar: 'avatars/300-12.jpg', email: 'redacted+002@example.invalid' },
            { value: 8, name: 'John Miller', avatar: 'avatars/300-13.jpg', email: 'redacted+015@example.invalid' }
        ];
