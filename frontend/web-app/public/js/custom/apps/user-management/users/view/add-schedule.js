...
var KTUsersAddSchedule = function () {
    ...
    var initAddSchedule = () => {       
        ...
        new Tagify(tagifyInput, {
            whitelist: ["redacted+024@example.invalid", "redacted+003@example.invalid", "redacted+014@example.invalid", "redacted+009@example.invalid", "redacted+018@example.invalid", "redacted+019@example.invalid", "redacted+004@example.invalid", "redacted+007@example.invalid", "redacted+002@example.invalid", "redacted+023@example.invalid", "redacted+012@example.invalid", "redacted+008@example.invalid"],
            maxTags: 10,
            dropdown: {
