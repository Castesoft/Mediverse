...
import { FilterForm, MedicineParams } from "../../_models/medicine";
...
@Component({
  selector: '[filterForm]',
  templateUrl: './medicines-filter-form.component.html',
  standalone: true,
...
export class MedicinesFilterFormComponent implements OnInit {
  modal: BsModalRef<MedicinesFilterModalComponent> = new BsModalRef<MedicinesFilterModalComponent>();
  ...
  constructor(public service: MedicinesService, public icons: IconsService) { }
